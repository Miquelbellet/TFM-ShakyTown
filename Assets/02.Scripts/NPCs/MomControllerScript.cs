...
public class MomControllerScript : MonoBehaviour
{
    ...
    public void ShowDialog()
    {
        ...
        {
            StreamReader linesDocument = resourcesManagmentScript.ReadDataFromResource("Assets/Resources/npcs/mom_lines.txt");
